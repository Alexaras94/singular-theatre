...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/sass/app.scss">run
            ...
            @foreach($venues as $venue)
                ...
                <h5 class="card-title">{{$venue->title}}</h5>
                    ...
                    <form method="POST" action="{{route('newreservation')}}">
                        ...
                        <label for="username" class="col-form-label"> 'Ονομα Κράτησης: </label>
                        <input type="text" name="username" class="form-control" id="username">
                        <label for="seats" class="col-form-label"> Θέσεις: </label>
                        <input type="number" name="seats"  class="form-control" id="seats">
                        <button class='btn btn-success' type='submit' >Κράτηση</button>
                            @if( (Auth::user()))
                                <a href="{{route('venue.edit',$venue)}}">
                                <button type="button" class="btn btn-primary">Επεξεργασία</button>
