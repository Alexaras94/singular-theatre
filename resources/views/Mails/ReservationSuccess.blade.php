                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                            ...
                                            <p
                                                ...
                                                <strong>Ημερομηνία&nbsp;παράστασης:</strong>&nbsp;{{ $venue->venue_date }}
                                            </p>

                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                <strong>Ώρα&nbsp;παράστασης:</strong>&nbsp;{{ $venue->venue_time }}
                                            </p>

                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                <strong>Ονοματεπώνυμο:</strong>&nbsp;{{ $reservation->username }}
                                            </p>

                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                <strong>Εταιρεία:</strong>&nbsp;{{ $reservation->company }}
                                            </p>
                                            </p>

                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                <strong>Αριθμός&nbsp;θέσεων:</strong>&nbsp;{{ $reservation->number_of_seats }}
                                            </p>
                                        </td>
                                    </tr>
                                </table>
